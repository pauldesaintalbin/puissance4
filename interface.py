...
COULEUR_ARRIERE_PLAN = '#FFD2D2'
COULEUR_JETON_ROUGE = "#FF5656"
COULEUR_JETON_JAUNE = "#FFFA80"
...
def placer_piece(plateau, boutons, jcj, colonne, piece_actuelle, texte_etat_partie):
    ...
    if coup_valide(plateau, colonne):
        ...
        print("piece posee")
        print(est_gagnant(plateau, piece_actuelle[0]))
        if est_gagnant(plateau, piece_actuelle[0])[0] or plateau_plein(plateau):
